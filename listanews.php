...
<body>
     ...
     <?php
        ...
        if ($lista) {
            $query = "SELECT * FROM newsletter order by telefon ASC";
        }
        else {
            $query = "SELECT *
                FROM newsletter
    ...
    <div class="bg-top">
        ...
        <div class="padding-container">
            <div class="container">
                ...
                <h1 class="main-title">Lista Abonati</h1>
    ...
    <div class="menu" id="meniu">
                ...
                <div class="container" style=" overflow-x: auto; ">
                    ...
                    if ($action == "view") {
                        if (!$lista) {
                            echo "<p>Ați selectat abonatul cu telefonul " . $telefon . ". Detalii:</p>";
                        } else {
                    ...
                    <table class="table table-dark table-hover">
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                echo "<tr>";
                                echo "<td><a href='listanews.php?telefon=".$row['telefon']."&action=view'>" . $row["telefon"] . "</a></td>";

                                echo "<td>" . $row["email"] . "</td>";
                                
                                echo "<td><a href='modnews.php?telefon=" . $row['telefon'] . " '><img src='img/edit.svg' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='listanews.php?telefon=" . $row['telefon'] . " &action=delete'><img src='img/trash.svg' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8'>Nu aveti abonati activi!</td></tr>";
                            }
                         ?>
						 </table>
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        //delete record
                        $query = "DELETE from newsletter where telefon=".$telefon;
                        $result=mysqli_query($conexiune, $query);

                        if (!$result) {
                            echo mysqli_error($conexiune);
                        } else {
                            echo "<h2 style='text-align:center;'>Abonatul a fost eliminat!</h2>";
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='listanews.php'\" >";
