...
<body>
     ...
     <?php
        ...
        if ($lista) {
            $query = "SELECT * FROM rezervari order by telefon ASC";
        }
        else {
            $query = "SELECT *
                FROM rezervari
    ...
    <div class="menu" id="meniu">
                ...
                <div class="container" style=" overflow-x: auto; ">
                    ...
                    if ($action == "view") {
                        if (!$lista) {
                            echo "<p>Ați selectat rezervarea cu telefonul " . $telefon . ". Detalii:</p>";
                        } else {
                    ...
                    <table class="table table-dark table-hover">
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                ...
                                echo "<td><a href='modrez.php?telefon=" . $row['telefon'] . " '><img src='img/edit.svg' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='listarez.php?telefon=" . $row['telefon'] . " &action=delete'><img src='img/trash.svg' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8'>Nu aveti rezervari active!</td></tr>";
                            }
                         ?>
						 </table>
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        //delete record
                        $query = "DELETE from rezervari where telefon=".$telefon;
                        $result=mysqli_query($conexiune, $query);

                        if (!$result) {
                            echo mysqli_error($conexiune);
                        } else {
                            echo "<h2 style='text-align:center;'>Rezervarea a fost stearsa!</h2>";
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='listarez.php'\" >";
