                    ...
                    if (isset($_GET['telefon'])) {
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (!$result) {
                                ...
                                echo "<p style='text-align:center;'>Înapoi la <a href='listacomenzi.php'>lista comenzilor</a>!";
                            }
                        } else {
                            ...
                            ?>
                            <form style="text-align:center;" id="editClient" action="modcomanda.php?telefon=<?=$telefon?>" method="post">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" type="text" name="adresa" id="adresa" value="<?=$row["adresa"]?>" >
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="meniu">Meniu:</label>
                                    <input class="form-control" type="text" name="meniu" id="meniu" value="<?=$row["meniu"]?>" >
                                </div>
                                <div class="form-group col-md-3">
                                </div>
                            </div>
                        ...
                        echo "<p>Lipsă paramentru (nu știu ce comanda să modific)</p>";
                        echo "<p>Mergeți înapoi la <a href='listacomenzi.php'>comenzi</a> și selectați una.</p>";
                    }
